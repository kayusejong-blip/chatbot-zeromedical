const chatDataRaw = {
  ...
  "nodes": {
    "START": {
        ...
        "options": [
            ...
            { "id": "OPT_BULK", "label": "💼 대량구매 문의", "next": "ESCALATE_BULK" }
        ]
    },
  ...
  "actions": {
    ...
    "REQUEST_VIDEO": {
      "id": "REQUEST_VIDEO",
      "type": "media_request",
      "message": "파악하기 어려운 증상이군요!\n현재 문제가 발생한 부위(또는 문제가 되는 부분)의 사진이나 짧은 영상을 촬영하여 이곳 창에 전송해 주시면, 저희 전문가가 확인 후 즉시 분석해드리겠습니다.",
      "options": [
        {
          "id": "UPLOAD_CAMERA",
    ...
    "ESCALATE_BULK": {
      "id": "ESCALATE_BULK",
      "type": "escalate",
      "message": "대량구매 전담 상담원과 즉시 연결해 드리겠습니다.\n\n원활한 상담 진행을 위해 하단 채팅창에 아래 양식을 작성해 주시면 대단히 감사하겠습니다.\n\n─────────────────────\n📋 [대량구매 문의 양식]\n- 문의 상품: (예: 상품명 또는 모델명)\n- 희망 수량: (예: 50개, 100개 등)\n- 희망 납기일: (예: 4월 30일까지 수령 희망)\n- 담당자 연락처: (성함 및 전화번호)\n─────────────────────"
    },
